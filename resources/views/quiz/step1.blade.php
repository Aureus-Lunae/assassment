          ...
          <div class="card-body">
            <form method="POST" action="/quiz">
              ...
              <div class="form-group row">
                <label for="question" class="col-md-4 col-form-label text-md-right">Vis je in diep water?</label>
              </div>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="question1" id="question1" value="2" required>
